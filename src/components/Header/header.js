      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        ...
        <div className="collapse navbar-collapse justify-content-start" id="navbarNavAltMarkup">
          <div className="navbar-nav">
            <a className="nav-item nav-link mr-4" href="/">Cursos <span className="sr-only">(current)</span></a>
        ...
        <div className="collapse navbar-collapse justify-content-end mr-5" id="navbarNavAltMarkup">
          <div className="navbar-nav">
            <a className="nav-item nav-link mr-3" data-toggle="modal" data-target="#registerModal" href="/teste">Cadastar</a>
